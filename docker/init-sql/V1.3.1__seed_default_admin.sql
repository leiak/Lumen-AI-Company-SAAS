...
INSERT IGNORE INTO sys_dept (dept_id, tenant_id, parent_id, ancestors, dept_name, order_num, leader_name, status, is_builtin) VALUES
...
INSERT IGNORE INTO sys_user (user_id, tenant_id, dept_id, user_name, nick_name, password, status, data_scope, mfa_enabled)
VALUES (1, 1, 100, 'admin', '超级管理员', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', 1, 0);

-- 默认角色
INSERT IGNORE INTO sys_role (role_id, tenant_id, role_name, role_key, role_sort, data_scope, status) VALUES
...
-- 默认岗位
INSERT IGNORE INTO sys_post (post_id, tenant_id, post_code, post_name, post_sort, status) VALUES
(1, 1, 'CEO',  '首席执行官', 1, '0'),
(2, 1, 'CTO',  '首席技术官', 2, '0'),
(3, 1, 'HR',   '人力资源',   3, '0'),
(4, 1, 'DEV',  '开发工程师', 4, '0');
...
-- 默认字典（用户性别 / 系统状态）
INSERT IGNORE INTO sys_dict_type (dict_id, tenant_id, dict_name, dict_type, status) VALUES
...
INSERT IGNORE INTO sys_dict_data (dict_sort, tenant_id, dict_label, dict_value, dict_type, status, is_default) VALUES
...
-- 默认参数配置
INSERT IGNORE INTO sys_config (tenant_id, config_name, config_key, config_value, config_type, is_builtin) VALUES
